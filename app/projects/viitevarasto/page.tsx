    ...
    <div className={styles.background}>
      ...
      <article className={styles.container}>
        <header className={styles.header}>
          ...
          <p>
            This is a university group project for a software production course.
            The idea is that the user can upload their BibTeX references onto
            the application and select which ones to compile into a references
            file for whatever document they are working on. This avoids having
            to manually manage the BibTeX file and updating the references
            throughout the document, and it also makes adding new references
            easier.
          </p>
        </header>
        ...
        <section className={styles.techAndDesignSection}>
          ...
          <p>
            ...
            and Python. Deployment is automated via GitHub Actions, and the app
            is pushed in a Docker container to{" "}
            <InlineLink href="https://fly.io/">fly.io</InlineLink>. The app
            contains automation tests and they are run as part of the deployment
            pipeline.
          </p>
          <br />
          <p>
        ...
        <section className={styles.creditsSection}>
          ...
          <p>
            ...
            project:{" "}
            <InlineLink href="https://github.com/DeeCaaD">@DeeCaaD</InlineLink>
            {", "}
            <InlineLink href="https://github.com/joonas-a">
              @joonas-a
            </InlineLink>
            {", "}
            <InlineLink href="https://github.com/Sidorow">@Sidorow</InlineLink>
            {", "}
