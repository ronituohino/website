    ...
    <div className={styles.background}>
      ...
      <article className={styles.container}>
        <header className={styles.header}>
          <h1 className={styles.title}>Recom, &quot;React e-commerce&quot;</h1>
        ...
        <section className={styles.storeSection}>
          <h2>The store</h2>
          <p>
            The style is this cartoonish &quot;hand-drawn&quot; look with all of
            the content in rounded and shadowed boxes. I decided to go with{" "}
            <InlineLink href="https://mui.com/">MUI</InlineLink> as the frontend
            framework, because at the time I wasn&apos;t comfortable with pure
            CSS. MUI also looked really clean and proved to be easy to use. The
            store supports multiple languages (Finnish & English). The store
            browser supports pagination, but I don&apos;t have enough items on
            sale for it to be apparent.
          </p>
        </section>
        ...
        <section className={styles.conclusionSection}>
          ...
          <p>
            ...
            have much experience with Docker), and figuring out file uploads to
            the server and syncing them when starting a new instance.
          </p>
          <br />
          <p>
            Overall I&apos;m very happy with how the backend works, but the
            frontend could use a little touch-up. The whole project isn&apos;t
            really &quot;production ready&quot;, but as a hobby project I think
            it&apos;s great!
          </p>
        </section>
      </article>
