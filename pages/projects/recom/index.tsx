  ...
  return (
    <article className={styles.container}>
      ...
      <div className={styles.description}>
        ...
        , and my first major web project. It consists of a store app, a backend
        server, a database, and an admin app. The user can add items from the
        store into their cart, and go through a full checkout process. The store
        can be managed through the admin application.
      </div>
