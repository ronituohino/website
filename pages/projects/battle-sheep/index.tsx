        ...
        <article className={styles.container}>
          <header className={styles.header}>
            ...
            <p>
              ...
              possible, but you can only move your sheep linearly by splitting
              up existing stacks of sheep. This project is about transfering the
              game onto the web, and implementing an AI adversary. This project
              was for a university algorithms course. If you want to try it out,
              I recommend playing on the &apos;open&apos; level.
            </p>
          </header>
          ...
          <section className={styles.aiSection}>
            ...
            <p>
              ...
              ordering&apos;. The online version makes the AI traverse the game
              tree until a depth of 6, i.e. find the best move for the next 6
            ...
            <br />
            <p>
              I&apos;m sure there is still plenty of room for optimization, but
              I didn&apos;t have time to explore further. One way to improve the
